...
movie_app = MovieApp(storage_1)
movie_app._command_list_movies()
#print(storage_1.list_movies())

#add_movies_test
#storage_1.add_movie("test_movie3", 1234, 10, 'poster_link', 'movie_url')
#print(storage_1.list_movies())

#delete_movies_test
#storage_1.delete_movie("test_movie3")
#print(storage_1.list_movies())
...
#movie_app._command_movie_stats()
#movie_app._command_ratings_histogram()
